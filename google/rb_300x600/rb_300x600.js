...
p.nominalBounds = new cjs.Rectangle(0,0,238,224);
...
p.nominalBounds = new cjs.Rectangle(0,0,256,163);


(lib.t2 = function() {
	this.initialize(img.t2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,257,65);


(lib.t3 = function() {
	this.initialize(img.t3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,247,166);
...
(lib.t1_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-128,-81);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-128,-81,256,163);
...
(lib.Symbol35 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-119,-112);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer 2
	this.instance_1 = new lib.cooler_sh();
	this.instance_1.setTransform(-182.4,-171.2,1.6,1.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-182.4,-171.2,364.8,342.4);
...
(lib.Symbol19 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-70,-214);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-70,-214,140,428);
...
(lib.t2_1 = function(mode,startPosition,loop) {
	...
	this.can.setTransform(0,-50);

	this.timeline.addTween(cjs.Tween.get(this.can).wait(1));

	// Layer 1
	this.instance = new lib.t2();
	this.instance.setTransform(-128,194);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-128,-264,257,523);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.mouse.setTransform(48,231);

	this.timeline.addTween(cjs.Tween.get(this.mouse).wait(1));

	// Layer 3
	this.cta = new lib.Symbol29();
	this.cta.setTransform(0,230,1.4,1.4);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	// Layer 1
	this.instance = new lib.t3();
	this.instance.setTransform(-123,-259);
...
p.nominalBounds = new cjs.Rectangle(-182.4,-259,364.8,517);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		tl.fromTo(r.blk, 0.2, {alpha:1}, {alpha:0, ease:Power0.easeNone})
		  ...
		  .to(r.t3.cta, 0.1, {scaleX:1.3, scaleY:1.3, ease:Sine.easeOut}, time4+1.6)
		  .to(r.t3.cta, 0.1, {scaleX:1.4, scaleY:1.4, ease:Sine.easeOut}, time4+1.8)
...
// stage content:
(lib.rb_300x600 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.btn.setTransform(150,300,1.667,2);
