...
p.nominalBounds = new cjs.Rectangle(0,0,145,138);
...
p.nominalBounds = new cjs.Rectangle(0,0,95,289);


(lib.t1 = function() {
	this.initialize(img.t1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,224,143);


(lib.t2 = function() {
	this.initialize(img.t2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,214,61);


(lib.t3 = function() {
	this.initialize(img.t3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,174,117);
...
(lib.Symbol35 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(-114,-107);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-114,-107,228,214);
...
(lib.Symbol34 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.bf(img.border, null, new cjs.Matrix2D(1,0,0,1,-120,-200)).s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(-0.1,-1);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-125.5,-206.1,250.8,410.2);
...
(lib.Symbol32 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-57,-11);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-57,-11,114,23);
...
(lib.Symbol26 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.t3, null, new cjs.Matrix2D(1,0,0,1,-87,-103)).s().p("AtlCMIAAkXIbLAAIAAEXg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-87,-14,174,28.1);
...
(lib.Symbol25 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.t3, null, new cjs.Matrix2D(1,0,0,1,-87,-74.7)).s().p("AtlCOIAAkbIbLAAIAAEbg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-87,-14.3,174,28.6);
...
(lib.Symbol24 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.t3, null, new cjs.Matrix2D(1,0,0,1,-87,-46.5)).s().p("AtlCLIAAkVIbLAAIAAEVg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-87,-13.9,174,27.9);
...
(lib.Symbol23 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.t3, null, new cjs.Matrix2D(1,0,0,1,-87,-16.3)).s().p("AtlCiIAAlDIbLAAIAAFDg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-87,-16.3,174,32.6);
...
(lib.Symbol21 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.t2, null, new cjs.Matrix2D(1,0,0,1,-107,-45.3)).s().p("AwtCdIAAk5MAhbAAAIAAE5g");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-107,-15.7,214,31.5);
...
(lib.Symbol20 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.t2, null, new cjs.Matrix2D(1,0,0,1,-107,-14.8)).s().p("AwtCTIAAklMAhbAAAIAAElg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-107,-14.7,214,29.6);
...
(lib.Symbol19 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-47,-144);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-47,-144,95,289);
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.t1, null, new cjs.Matrix2D(1,0,0,1,-112,-25.6)).s().p("AxeEAIAAn/MAi9AAAIAAH/g");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-112,-25.6,224,51.3);
...
(lib.Symbol17 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.t1, null, new cjs.Matrix2D(1,0,0,1,-112,-74)).s().p("AxeDjIAAnFMAi9AAAIAAHFg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-112,-22.7,224,45.5);
...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.t1, null, new cjs.Matrix2D(1,0,0,1,-112,-119.8)).s().p("AxeDnIAAnNMAi9AAAIAAHNg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-112,-23.1,224,46.3);
...
(lib.Symbol15 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("A6QaNQq2q3gBvWQABvWK2q6QK6q3PWAAQPWAAK3K3QK7K6gBPWQABPWq7K3Qq3K7vWgBQvWABq6q7g");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-237.6,-237.6,475.2,475.2);
...
(lib.t1_1 = function(mode,startPosition,loop) {
	...
	this.t1.setTransform(0,-45.3);

	this.t2 = new lib.Symbol17();
	this.t2.setTransform(0,3);

	this.t3 = new lib.Symbol16();
	this.t3.setTransform(0,48.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.t3},{t:this.t2},{t:this.t1}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-112,-71,224,143);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.mouse.setTransform(48,161);

	this.timeline.addTween(cjs.Tween.get(this.mouse).wait(1));

	// Layer 3
	this.cta = new lib.Symbol29();
	this.cta.setTransform(0,160);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	// Layer 1
	this.t4 = new lib.Symbol26();
	this.t4.setTransform(0,-66);

	this.t3 = new lib.Symbol25();
	this.t3.setTransform(0,-94.3);

	this.t2 = new lib.Symbol24();
	this.t2.setTransform(0,-122.5);

	this.t1 = new lib.Symbol23();
	this.t1.setTransform(0,-152.7);

	this.cooler = new lib.Symbol22();
	this.cooler.setTransform(0,50);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cooler},{t:this.t1},{t:this.t2},{t:this.t3},{t:this.t4}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-114,-169,228,352);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		tl.fromTo(r.blk, 0.2, {alpha:1}, {alpha:0, ease:Power0.easeNone})
		  ...
		  .staggerFrom([r.t1.t1, r.t1.t2, r.t1.t3], 0.3, {x:"-=120", alpha:0, rotation:"+=0.1", ease:Back.easeOut.config(0.9,0.4)}, 0.0, time2+0.1)
		  
		  //
		  .staggerTo([r.t1.t1, r.t1.t2, r.t1.t3], 0.0001, {x:"-=400", rotation:"+=0.1"/*, ease:Expo.easeIn*/}, 0.00, time3+0.0)
		  ...
		  .staggerTo([r.t2.can, r.t2.t1, r.t2.t2], 0.001, {y:"-=400"}, 0.0, time4+0.3)
		  .staggerFrom([r.t3.t1, r.t3.t2, r.t3.t3, r.t3.t4, r.t3.cooler], 0.001, {y:"+=600"}, 0.0, time4+0.4)
		  ...
		  //.from(r.t3.cta, 0.8, {rotation:"-=360",ease:Sine.easeOut}, time4+0.9)
		  //.from(r.t3.cta.c1, 0.8, {x:150, alpha:0, ease:Sine.easeOut}, time4+0.9)
		  //.from(r.t3.cta.c2, 0.8, {x:-150, alpha:0, ease:Sine.easeOut}, time4+0.9)
		  //.from(r.t3.cta.c3, 0.8, {y:150, alpha:0, ease:Sine.easeOut}, time4+0.9)
		  //.from(r.t3.cta.c4, 0.8, {y:-150, alpha:0, ease:Sine.easeOut}, time4+0.9)
		  ...
		  //.to(r.cans.b2.sh, 0.7, {x:"-=400", ease:Expo.easeIn}, time2+0.0)
		  //.to(r.cans.b2, 0.7, {x:"-=400", rotation:"+=0.1", ease:Expo.easeIn}, time2+0.1)
		  //.staggerTo([r.logo1, r.logo2], 0.7, {x:"-=300", ease:Expo.easeIn}, 0.03, time2+0.0)
		  //
		  //
		  //.from(r.girl, 1.2, {scaleX:0.7, scaleY:0.7, alpha:0, rotation:"+=0.1", ease:Expo.easeOut}, time2+0.8)
		  //.to(r.girl, 1.0, {x:"+=0", ease:Expo.easeOut}, time2+2.5)
		  //.call(blink)
		  //
		  ////3
		  //.staggerTo([r.t1.t1, r.t1.t2, r.t1.t3, r.t1.t4], 0.6, {x:"-=200", alpha:0, ease:Expo.easeIn}, 0.04,  time3+0.0)
		  //.to(r.girl, 1.0, {x:-148, y:203, scaleX:0.85, scaleY:0.85, ease:Expo.easeInOut}, time3+0.0)
		  //.staggerFrom([r.logo3, r.logo4, r.logo4.mc], 1.4, {x:"+=200", alpha:0, ease:Expo.easeOut}, 0.08, time3+0.6)
		  //.staggerFrom([r.t2.t1, r.t2.t2, r.t2.t4, r.t2.t5], 1.4, {x:"+=200", alpha:0, ease:Expo.easeOut}, 0.08, time3+0.7)
		...
		function blink() {
			TweenMax.to(r.girl.words.mc1, 0.5, {alpha:0, yoyo:true, repeat:3, delay:0.1, ease:Power0.easeNone});
			TweenMax.to(r.girl.words.mc2, 0.4, {alpha:0, yoyo:true, repeat:3, delay:0.3, ease:Power0.easeNone});
			TweenMax.to(r.girl.words.mc3, 0.6, {alpha:0, yoyo:true, repeat:3, delay:0.2, ease:Power0.easeNone});
			TweenMax.to(r.girl.words.mc4, 0.5, {alpha:0, yoyo:true, repeat:3, delay:0.4, ease:Power0.easeNone});
		}
		...
		function startWords() {
			...
			for (currObj in z) {
			  if(z[currObj] && typeof z[currObj] == "object" && i>=56){
				  //TweenMax.from(z[currObj], 2.0, {scaleX:0, scaleY:0, rotation:"+=0", y:"+=100", /*alpha:0, */ease:Elastic.easeOut.config(0.9,0.6), delay:(i-56)*0.005+6.0});
	...
	this.desk.setTransform(10,0,0.95,0.95);
...
// stage content:
(lib.rb_240x400 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
