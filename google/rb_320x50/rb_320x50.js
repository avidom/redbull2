...
p.nominalBounds = new cjs.Rectangle(0,0,199,15);


(lib.t3 = function() {
	this.initialize(img.t3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,150,27);
...
p.nominalBounds = new cjs.Rectangle(-64,-17,128,35);
...
(lib.Symbol35 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(-31.9,-29.9,0.28,0.28);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-31.9,-29.9,63.9,59.9);
...
p.nominalBounds = new cjs.Rectangle(-25,-25,51,50);
...
(lib.t2_1 = function(mode,startPosition,loop) {
	...
	this.can.setTransform(105,0);

	this.timeline.addTween(cjs.Tween.get(this.can).wait(1));

	// Layer 1
	this.instance = new lib.t2();
	this.instance.setTransform(-139,-7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-139,-25,270,50);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		tl.fromTo(r.blk, 0.2, {alpha:1}, {alpha:0, ease:Power0.easeNone})
		  ...
		  .to(r.t3.cta, 0.1, {scaleX:0.4, scaleY:0.4, ease:Sine.easeOut}, time4+1.6)
		  .to(r.t3.cta, 0.1, {scaleX:0.5, scaleY:0.5, ease:Sine.easeOut}, time4+1.8)
	...
	this.blk.setTransform(0,0,1.067,0.083);
...
p.nominalBounds = new cjs.Rectangle(-172.6,-172.6,345.3,345.3);


// stage content:
(lib.rb_320x50 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.btn.setTransform(160,25,1.778,0.167);
	...
	mask._off = true;
	mask.graphics.p("A4/D5IAAnxMAx/AAAIAAHxg");
	mask.setTransform(160,25);

	// movie
	this.rolik = new lib.content();
	this.rolik.setTransform(160,25);
