...
p.nominalBounds = new cjs.Rectangle(0,0,45,139);


(lib.t1 = function() {
	this.initialize(img.t1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,149,94);
...
p.nominalBounds = new cjs.Rectangle(0,0,187,35);
...
p.nominalBounds = new cjs.Rectangle(-74,-47,149,94);
...
(lib.Symbol35 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-48,-45);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer 2
	this.instance_1 = new lib.cooler_sh();
	this.instance_1.setTransform(-74.1,-69.5,0.65,0.65);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-74.1,-69.5,148.2,139.1);
...
(lib.Symbol19 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-22,-69);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-22,-69,45,139);
...
(lib.t2_1 = function(mode,startPosition,loop) {
	...
	this.can.setTransform(0,-19);

	this.timeline.addTween(cjs.Tween.get(this.can).wait(1));

	// Layer 1
	this.instance = new lib.t2();
	this.instance.setTransform(-61,58);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-61,-88,123,177);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		tl.fromTo(r.blk, 0.2, {alpha:1}, {alpha:0, ease:Power0.easeNone})
		  ...
		  .to(r.t3.cta, 0.1, {scaleX:0.6, scaleY:0.6, ease:Sine.easeOut}, time4+1.6)
		  .to(r.t3.cta, 0.1, {scaleX:0.7, scaleY:0.7, ease:Sine.easeOut}, time4+1.8)
	...
	this.desk.setTransform(0,-5,0.62,0.62);
...
// stage content:
(lib.rb_200x200 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.btn.setTransform(100,100,1.111,0.667);
	...
	mask._off = true;
	mask.graphics.p("AvnPnIAA/NIfPAAIAAfNg");
	mask.setTransform(100,100);

	// movie
	this.rolik = new lib.content();
	this.rolik.setTransform(100,100);
