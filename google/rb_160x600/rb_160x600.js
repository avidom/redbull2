...
p.nominalBounds = new cjs.Rectangle(0,0,157,148);
...
p.nominalBounds = new cjs.Rectangle(0,0,112,22);
...
p.nominalBounds = new cjs.Rectangle(0,0,105,319);


(lib.t1 = function() {
	this.initialize(img.t1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,145,91);
...
p.nominalBounds = new cjs.Rectangle(0,0,145,97);
...
p.nominalBounds = new cjs.Rectangle(-72,-45,145,91);
...
(lib.Symbol35 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-78,-74);
...
(lib.Symbol32 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-56,-11);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-56,-11,112,22);
...
(lib.Symbol19 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-52,-159);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-52,-159,105,319);
...
(lib.t2_1 = function(mode,startPosition,loop) {
	...
	this.can.setTransform(0,-10);

	this.timeline.addTween(cjs.Tween.get(this.can).wait(1));

	// Layer 1
	this.instance = new lib.t2();
	this.instance.setTransform(-71,240);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-71,-169,143,445);
...
(lib.Symbol22 = function(mode,startPosition,loop) {
	...
	this.mc.setTransform(0,-30);

	this.timeline.addTween(cjs.Tween.get(this.mc).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-114,-137,228,214);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.mouse.setTransform(41,230);

	this.timeline.addTween(cjs.Tween.get(this.mouse).wait(1));

	// Layer 3
	this.cta = new lib.Symbol29();
	this.cta.setTransform(0,221,0.9,0.9);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(1));

	// Layer 1
	this.instance = new lib.t3();
	this.instance.setTransform(-72,-242);
...
p.nominalBounds = new cjs.Rectangle(-114,-242,228,494);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		tl.fromTo(r.blk, 0.2, {alpha:1}, {alpha:0, ease:Power0.easeNone})
		  ...
		  .to(r.t3.cta, 0.1, {scaleX:0.8, scaleY:0.8, ease:Sine.easeOut}, time4+1.6)
		  .to(r.t3.cta, 0.1, {scaleX:0.9, scaleY:0.9, ease:Sine.easeOut}, time4+1.8)
...
// stage content:
(lib.rb_160x600 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.btn.setTransform(80,300,0.889,2);
	...
	mask._off = true;
	mask.graphics.p("EgMfAu3MAAAhdtIY/AAMAAABdtg");
	mask.setTransform(80,300);

	// movie
	this.rolik = new lib.content();
	this.rolik.setTransform(80,300);
